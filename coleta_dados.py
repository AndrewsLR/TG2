...
routable_data = data[data["routable"] == 1]
...
routable_data = data[data["routable"] == 1]
lines_total  = data["lines"].value_counts().to_dict()
inputs_total = data["inputs"].value_counts().to_dict()
gaps_total   = data["gaps"].value_counts().to_dict()
